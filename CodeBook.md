...
```
Avg_Mean	6		num
	 Average of the Mean for all the components of the signals on each of the axis (when applicable) captured by 
...
Avg_Standard_Deviation	7 num  
	Average of the Standard Deviation for all the components signals on each of the axis (when applicable) 
    captured by Activity and the Subject 
```